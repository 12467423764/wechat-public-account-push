export const config = {
  ...
  // 如果你非要填这里也行。脚本也能运行
  APP_ID: "wx52508744186ba850",

  // 公众号APP_SECRET
  // 建议不要填这里，请使用文档中github secret的方法进行保密配置，保护您的隐私安全。
  // 如果你非要填这里也行。脚本也能运行
  APP_SECRET: "36bb685cd2ca00a7be43bfa9fd9fdc8b",
...
//       id: "oXpdU6JqzvHg7sdam0YVRNpz0jyQ",
//       // 你想对他发送的模板消息的模板ID
//       useTemplateId: "	fHg-eBWdnFgZVYgOuuwfgeG6SleQ5lnG59fa3VpA1-w",
//       // 所在省份
//       province: "广东",
//       // 所在城市
//       city: "肇庆",
...
//   CALLBACK_TEMPLATE_ID: "fHg-eBWdnFgZVYgOuuwfgeG6SleQ5lnG59fa3VpA1-w",
